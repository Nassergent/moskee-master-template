    ...
    defineField({
      ...
      fields: [
        ...
        defineField({
          ...
          type: 'boolean',
          initialValue: true,
          description: 'Toon de doneren-pagina en doneerknop in de navigatie.',
        }),
        defineField({
          name: 'showAgenda',
          title: 'Toon Agenda',
          type: 'boolean',
          initialValue: true,
          description: 'Toon de agenda/activiteiten-pagina in de navigatie.',
        }),
        defineField({
          name: 'showJanazah',
          title: 'Toon Janazah',
          type: 'boolean',
          initialValue: true,
          description: 'Toon de janazah-pagina en janazah-banner op de homepage.',
        }),
        defineField({
          name: 'showGebedstijden',
          title: 'Toon Gebedstijden',
          type: 'boolean',
          initialValue: true,
          description: 'Toon de gebedstijden-pagina in de navigatie.',
        }),
        defineField({
          name: 'showVrijwilligers',
          title: 'Toon Vrijwilligers',
          type: 'boolean',
          initialValue: true,
          description: 'Toon de vrijwilligers-sectie op de over-ons pagina.',
        }),
        defineField({
          name: 'showNieuws',
          title: 'Toon Nieuws',
          type: 'boolean',
          initialValue: true,
          description: 'Toon de nieuws-pagina en de actueel-sectie op de homepage.',
        }),
      ],
    }),
    defineField({
