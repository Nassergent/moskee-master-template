...
- [x] **Phase 4: Centrale Demo Mode Helper** - Alle hardcoded test values vervangen door isDemoMode()
...
Plans:
- [x] 04-01-PLAN.md — Centrale isDemoMode() helper + migratie 7 locaties (incl. reconcile-mollie.ts)
